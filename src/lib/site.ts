...
/**
 * The site-wide OG card generated by `src/app/opengraph-image.tsx`. Next
 * attaches that file to the root segment's metadata, but any page that
 * defines its own `openGraph` object replaces the inherited one wholesale,
 * images included — so blog pages reference the card explicitly.
 */
export const OG_IMAGE = {
  url: "/opengraph-image",
  width: 1200,
  height: 630,
  alt: "HackAotearoa — the co-working community for NZ startup builders",
};
